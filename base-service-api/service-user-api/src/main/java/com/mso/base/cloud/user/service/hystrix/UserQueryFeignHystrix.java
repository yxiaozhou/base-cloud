...
package com.mso.base.cloud.user.service.hystrix;

import com.mso.base.cloud.common.wrapper.Wrapper;
import com.mso.base.cloud.user.service.UserQueryFeignApi;
...
public class UserQueryFeignHystrix implements UserQueryFeignApi {
	...
	@Override
	public Wrapper<Object> getById(final Long addressId) {
		return null;
	}
}
