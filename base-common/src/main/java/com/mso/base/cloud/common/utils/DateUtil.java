...
public class DateUtil {
     ...
     * @return
     */
    public static String getTimePlus(Date date) {
     ...
     * @return
     */
    public static String getAllTimePlus() {
        return formatDate(new Date(), "yyyyMMddHHmmssSSS");
    }

    /**
     * 获取YYYYMMDDHHmmssSSS格式(Long返回)
     *
     * @return
     */
    public static Long getAllTimePlusLong() {
     ...
     */
    public static List<String> getDates(Integer days) {
